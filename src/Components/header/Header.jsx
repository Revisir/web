...
import TopicModal from "../addTopicModal/TopicModal";
...
function Header() {
  ...
  return (
    <div>
        ...
        <header className="d-flex flex-wrap align-items-center justify-content-between py-3 mb-4 border-bottom">
          ...
          {loggedIn ? (
            <div className="d-flex align-items-end justify-content-center">
              <div className="me-4 d-none d-md-block header__icon" onClick={addNewTopic}>
      ...
      <div className="popUp__addTopic d-md-none d-block" onClick={addNewTopic}>
